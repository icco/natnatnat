 ...
 * Some sort of digital deaddrop wifi thing
 * Rebuild pgp.io
 ...
 * Some sort of tamogachi clone that uses AR
 ...
 * A media recommendation engine to recomend new shows based off of trakt.tv usage
 * A vangaurd fund recommendation engine
 * A simcity AI
 * A simtower AI
 ...
 * Build a version of Harajuku Fun Madness from LittleBrother
